...
////size of num_allocated_pages_+num_extents_ is 8, (PAGE_SIZE - 8) is the rest bytes,so /4 get the number of extent
...
class DiskFileMetaPage {
 ...
 public:
  ...
  ////[i] return the number of used pages in i-th extent,so this array size is num_extents_ 
};
