...
class Page {
 ...
 public:
  ...
  inline void WLatch() {/* std::cerr<<page_id_<<" WLatch\n"; */ rwlatch_.WLock(); }

  /** Release the page write latch. */
  inline void WUnlatch() {/* std::cerr<<page_id_<<" WUnLatch\n"; */ rwlatch_.WUnlock(); }

  /** Acquire the page read latch. */
  inline void RLatch() {/* std::cerr<<page_id_<<"RLatch\n"; */ rwlatch_.RLock(); }

  /** Release the page read latch. */
  inline void RUnlatch() {/* std::cerr<<page_id_<<"RUnLatch\n"; */ rwlatch_.RUnlock(); }
