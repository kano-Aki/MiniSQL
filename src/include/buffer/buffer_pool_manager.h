...
class BufferPoolManager {
 public:
  ...
  int testt(){cerr<<"testt "<<pages_[7].pin_count_<<'\n';}
...
////while no free page,use replacer to decide which page to be replaced
////NewPage is just to allocate a free space from disk,that is mark a page to be used(change the corresponding bitmap)
////fetchPage is get the content of the page
